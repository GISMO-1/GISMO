...
def build_system_prompt(
    *,
    ...
    return (
        ...
        "(echo:, note:, shell:, device:, calendar:, graph:). "
        ...
        "command must be a GISMO operator command string (echo:, note:, shell:, device:, calendar:, or graph:), "
        "for example \"echo: hello\". "
        "Use device: commands for connected-device work when appropriate, such as "
        "\"device: scan\", \"device: list\", \"device: check cameras\", "
        "\"device: check front door camera\", or \"device: turn on kitchen lights\". "
        "Use calendar: commands for local calendar changes when appropriate, such as "
        ...
        "\"risk\":\"low\"}],\"notes\":[]}\n"
        "{\"intent\":\"operate\",\"assumptions\":[\"Operator requested a device check\"],"
        "\"actions\":[{\"type\":\"enqueue\",\"command\":\"device: check cameras\","
        "\"timeout_seconds\":30,\"retries\":0,\"why\":\"check saved cameras\","
        "\"risk\":\"medium\"}],\"notes\":[]}\n"
        "{\"intent\":\"operate\",\"assumptions\":[\"Operator requested a calendar event\"],"
        "\"actions\":[{\"type\":\"enqueue\",\"command\":\"calendar: add {\\\"title\\\":\\\"Dinner\\\",\\\"start_at\\\":\\\"2026-03-20T18:00:00\\\",\\\"end_at\\\":\\\"2026-03-20T19:00:00\\\"}\","
        "\"timeout_seconds\":30,\"retries\":0,\"why\":\"add the event to the local calendar\","
        "\"risk\":\"high\"}],\"notes\":[]}\n"
